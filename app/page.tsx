          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-bold text-sm !text-white">Search Player</div>
                  <div className="text-xs opacity-75 !text-slate-300">Parent Location Tracker</div>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-bold text-sm !text-white">Membership</div>
                  <div className="text-xs opacity-75 !text-slate-300">VIP Perks & Rewards</div>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-bold text-sm !text-white">Staff Branch</div>
                  <div className="text-xs opacity-75 !text-slate-300">Check In / Out Portal</div>
                </div>
              </div>
                ...
                <div className="space-y-6 pt-2">
                  ...
                  <div className="bg-slate-900/90 border border-white/15 rounded-2xl p-6 shadow-xl space-y-4">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border-b border-white/10 pb-4">
                      <div>
                        <h3 className="text-2xl font-black !text-white flex items-center gap-2 capitalize">
                            ...
                            {historyLogs.map((log) => (
                              <tr key={log.id} className="hover:bg-white/5 transition-colors">
                                ...
                                <td className="py-3 px-2">
                                  <span className={`inline-block px-3 py-1 rounded-full text-xs font-extrabold !text-white ${
                                    log.status === 'Active'
