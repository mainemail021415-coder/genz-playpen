          ...
          <div className="space-y-6">
            ...
            {playerInfo && (
              <div className="space-y-6 max-w-2xl mx-auto">
                ...
                {/* Logs Card - INLINE STYLES FORCED VISIBILITY */}
                  ...
                  {historyLogs.length === 0 ? (
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-sm">
                        <thead>
                          <tr className="border-b border-slate-700 uppercase tracking-wider font-extrabold text-xs">
                            {/* PWERSAHANG INLINE COLOR PARA HINDI MA-OVERRIDE */}
                            <th className="pb-3 pt-1" style={{ color: '#ffffff' }}>Branch</th>
                            <th className="pb-3 pt-1" style={{ color: '#ffffff' }}>Status</th>
                            <th className="pb-3 pt-1" style={{ color: '#ffffff' }}>Petsa at Oras</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-800">
                          {historyLogs.map((log) => (
                            <tr key={log.id} className="hover:bg-slate-800/30 transition-colors">
                              ...
                              {/* PWERSAHANG PUTI SA MGA DATA ORAS */}
                              <td className="py-3 text-sm font-semibold" style={{ color: '#e2e8f0' }}>
